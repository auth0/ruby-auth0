...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionUpdatedPreviousObject4Options < Internal::Types::Model
      ...
      field :set_user_root_attributes, -> { Auth0::Types::EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsSetUserRootAttributesEnum }, optional: true, nullable: false

      field :should_trust_email_verified_connection, -> { Auth0::Types::EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsShouldTrustEmailVerifiedConnectionEnum }, optional: true, nullable: false
