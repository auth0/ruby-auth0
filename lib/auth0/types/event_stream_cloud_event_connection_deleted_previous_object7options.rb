...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionDeletedPreviousObject7Options < Internal::Types::Model
      ...
      field :federated_connections_access_tokens, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens }, optional: true, nullable: false

      field :granted, -> { Internal::Types::Boolean }, optional: true, nullable: false

      field :icon_url, -> { String }, optional: true, nullable: false

      field :identity_api, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityAPIEnum }, optional: true, nullable: false
      ...
      field :set_user_root_attributes, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum }, optional: true, nullable: false

      field :should_trust_email_verified_connection, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum }, optional: true, nullable: false
      ...
      field :userid_attribute, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum }, optional: true, nullable: false

      field :waad_protocol, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum }, optional: true, nullable: false
    end
  end
end
