...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionCreatedPreviousObject2Options < Internal::Types::Model
      field :assertion_decryption_settings, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsAssertionDecryptionSettings }, optional: true, nullable: false

      field :cert, -> { String }, optional: true, nullable: false

      field :cert_rollover_notification, -> { String }, optional: true, nullable: false

      field :digest_algorithm, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsDigestAlgorithmEnum }, optional: true, nullable: false, api_name: "digestAlgorithm"
      ...
      field :idpinitiated, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsIdpinitiated }, optional: true, nullable: false

      field :non_persistent_attrs, -> { Internal::Types::Array[String] }, optional: true, nullable: false

      field :protocol_binding, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsProtocolBindingEnum }, optional: true, nullable: false, api_name: "protocolBinding"

      field :set_user_root_attributes, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSetUserRootAttributesEnum }, optional: true, nullable: false

      field :signature_algorithm, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSignatureAlgorithmEnum }, optional: true, nullable: false, api_name: "signatureAlgorithm"
      ...
      field :subject, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSubject }, optional: true, nullable: false
      ...
      field :oidc_metadata, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject2OptionsOidcMetadata }, optional: true, nullable: false
