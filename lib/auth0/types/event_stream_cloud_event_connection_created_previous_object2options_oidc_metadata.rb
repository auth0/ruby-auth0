...
module Auth0
  module Types
    ...
    # https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata. Used with Cross App Access.
    class EventStreamCloudEventConnectionCreatedPreviousObject2OptionsOidcMetadata < Internal::Types::Model
