...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionCreatedPreviousObject0OptionsAttributeMap < Internal::Types::Model
      ...
      field :mapping_mode, -> { Auth0::Types::EventStreamCloudEventConnectionCreatedPreviousObject0OptionsAttributeMapMappingModeEnum }, optional: true, nullable: false
    end
  end
end
