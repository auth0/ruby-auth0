...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionDeletedPreviousObject0OptionsAttributeMap < Internal::Types::Model
      ...
      field :mapping_mode, -> { Auth0::Types::EventStreamCloudEventConnectionDeletedPreviousObject0OptionsAttributeMapMappingModeEnum }, optional: true, nullable: false
    end
  end
end
