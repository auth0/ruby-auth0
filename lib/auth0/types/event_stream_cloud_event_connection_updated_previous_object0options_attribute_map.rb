...
module Auth0
  module Types
    ...
    class EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsAttributeMap < Internal::Types::Model
      ...
      field :mapping_mode, -> { Auth0::Types::EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsAttributeMapMappingModeEnum }, optional: true, nullable: false
    end
  end
end
